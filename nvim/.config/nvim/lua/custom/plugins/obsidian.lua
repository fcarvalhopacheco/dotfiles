return {
  ...
  config = function(_, opts)
    ...
    map('n', '<leader>on', '<cmd>ObsidianNew<cr>', { desc = '[O]bsidian [N]ew' })
    map('n', '<leader>ol', '<cmd>ObsidianLinks<cr>', { desc = '[O]bsidian [L]inks' })
    map('n', '<leader>ob', '<cmd>ObsidianBacklinks<cr>', { desc = '[O]bsidian [B]acklinks' })
    map('n', '<leader>otd', '<cmd>ObsidianToday<cr>', { desc = '[O]bsidian [T]o[d]ay' })
    map('n', '<leader>otm', '<cmd>ObsidianTomorrow<cr>', { desc = '[O]bsidian [T]o[m]orrow' })
    map('n', '<leader>otp', '<cmd>ObsidianTemplate<cr>', { desc = '[O]bsidian [T]em[p]late' })
    map('n', '<leader>otg', '<cmd>ObsidianTags<cr>', { desc = '[O]bsidian [T]a[g]s' })
    map('n', '<leader>oy', '<cmd>ObsidianYesterday<cr>', { desc = '[O]bsidian [Y]esteray' })
    -- map('n', '<leader>owp', '<cmd>ObsidianWorkspace 1.Projects<cr>', { desc = '[O]bsidian [W]orkspace [P]roject' })
    -- map('n', '<leader>owa', '<cmd>ObsidianWorkspace 2.Areas<cr>', { desc = '[O]bsidian [W]orkspace [A]rea' })
  ...
  opts = {
    ...
    workspaces = {
      {
        name = 'zettlekasten',
        path = '/Users/fcp/Documents/zettelkasten',
      },
      -- {
      --   name = "work",
      --   path = "~/vaults/work",
    ...
    notes_subdir = '/Users/fcp/Documents/zettelkasten/0.Fleeting',
    ...
    templates = {
      ...
      -- | `{{hdate}}`         | Current date in a human-readable format     | "Wednesday, March 6th, 2024"          |
